...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="rel<?php echo gefnm("/at/favicon.ico");?>">
        <link rel="stylesheet" href="rel<?php echo gefnm("/styles__lta.css");?>">
    </head>
    <body>
                ...
                <div role="main" class="container-fluid">
                    <div class="d-flex flex-container Card">
                        <app-header class="d-flex flex-container" _nghost-ybr-c28="">
                            <!---->
                            <div class="image ng-star-inserted"><img id="headerLogoImage" alt="" class="mar-b4 header-logo-image" style="width: 100%;" src="rel<?php echo gefnm("/at/att-logo.svg");?>"></div>
                            <!---->
